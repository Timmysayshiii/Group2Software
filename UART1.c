...
void UART1_Init(void){
	//SYSCTL_RCGC1_R |= 0x00000002;  // activate UART1 || Uart3= 0x00000008; 
	
	SYSCTL_RCGC1_R |= 0x00000002;  // activate UART 1
  SYSCTL_RCGC2_R |= 0x00000004;  // activate port C
	
  UART1_CTL_R &= ~0x00000001;    // disable UART
  UART1_IBRD_R = 521;     // IBRD = int(80,000,000/(16*9600)) = int(520.8333)
  ...
  GPIO_PORTC_PCTL_R = (GPIO_PORTC_PCTL_R&0x0000FFFF)+0x11220000;
...
void UART2_Init(void){
  ...
  UART2_IBRD_R = 521;     // IBRD = int(80,000,000/(16*9600)) = int(520.8333)
...
void UART5_Init(void){
  ...
  UART5_IBRD_R = 521;     // IBRD = int(80,000,000/(16*9600)) = int(520.8333)
  ...
  GPIO_PORTE_AFSEL_R |= 0x30;    // enable alt funct on PD6-7
  GPIO_PORTE_DEN_R |= 0x30;      // configure PD6-7 as UART1
  GPIO_PORTE_PCTL_R = (GPIO_PORTD_PCTL_R&0x00FFFFFF)+0x11000000;
  GPIO_PORTE_AMSEL_R &= ~0x30;   // disable analog on PD6-7
}
...
void UART3_Init(void){
  ...
  UART3_IBRD_R = 521;     // IBRD = int(80,000,000/(16*9600)) = int(520.8333)
...
//  GPIO_PORTC_DEN_R |= 0xC0;      // configure PC6-7 as UART3
//  GPIO_PORTC_PCTL_R = (GPIO_PORTC_PCTL_R&0x00FFFFFF)+0x11000000;
